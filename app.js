...
const configBinanceController = require('./controllers/ConfigBinanceController');
const walletController = require('./controllers/WalletController');
const helper = require('./helpers/helper');
const seeder = require('./helpers/seeder');
const topVolumeBittrex = require('./helpers/TopVolumeBittrex');
const topVolumeBinance = require('./helpers/TopVolumeBinance');
...
app.get('/checkSideway', passportConfig.isAuthenticated, NavigationMiddleware, listCoinController.getListCoinSideWay);
...
app.get('/listCoinBnB', passportConfig.isAuthenticated, NavigationMiddleware, configBinanceController.getListCoinBnB);
app.post('/admin/selectCoinActiveCheck',passportConfig.isAuthenticated, configBinanceController.postSelectCoinActiveCheck);
app.get('/removeCheckBnB', passportConfig.isAuthenticated, configBinanceController.removeCheckBnB);
